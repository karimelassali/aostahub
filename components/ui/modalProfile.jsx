...
const AlertDialogOverlay = React.forwardRef(({ className
, ...props }, ref) => (
...
const AlertDialogHeader = ({ className, ...props }) => (
  <div
    className={cn(
      "flex flex-col items-center justify-center space-y-2 text-center sm:text-left",
      className
    )}
    {...props}
  />
...
const AlertDialogAction = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonVariants(), "text-primary", className)}
    {...props}
  />
))
